...
# --- Constants ---
STATE_SIZE = 3 # 5  # [humanity, avg_humanity, captchas_solved, last_solved_status, server_total_users]
...
class ThreatAssessor:
    ...
    def normalize_state(self, state):
        ...
        state_copy[0] = np.tanh(state_copy[0] / 5.0)
        state_copy[1] = state_copy[1] / 10.0
        state_copy[2] = state_copy[2] / 300.0
        return state_copy
